...
public class VeiculoExploracaoNaoEncontradoException extends RuntimeException {
	...
	public static final String MENSAGEM = "O Veículo de Exploração com identificador [%s] não pode ser encontrado!";

	public VeiculoExploracaoNaoEncontradoException(String identificadorVeiculo) {
